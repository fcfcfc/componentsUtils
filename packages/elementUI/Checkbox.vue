<template>
    <div :class="`abc_${squareInnerHeight}_${squareInnerWidth}_${squareInnerLeft}_${squareInnerTop}_${squareInnerBorderSize}`"
         :style="{'font-size': fontSize}"
         class="myCheckbox">
        <el-checkbox-group ref="myCheckbox" @change="valueChange" v-model="checkboxValue">
...
<script>
    ...
    export default {
        ...
        mounted() {
            let rule = `.abc_${this.squareInnerHeight}_${this.squareInnerWidth}_${this.squareInnerLeft}_${this.squareInnerTop}_${this.squareInnerBorderSize} .el-checkbox__input>.el-checkbox__inner::after`;
            if(this.squareInnerHeight) {
                document.styleSheets[0].addRule(rule, `height: ${this.squareInnerHeight} !important`);
            }
            if(this.squareInnerWidth) {
                document.styleSheets[0].addRule(rule, `width: ${this.squareInnerWidth} !important`);
            }
            if(this.squareInnerLeft) {
                document.styleSheets[0].addRule(rule, `left: ${this.squareInnerLeft} !important`);
            }
            if(this.squareInnerTop) {
                document.styleSheets[0].addRule(rule, `top: ${this.squareInnerTop} !important`);
            }
            if(this.squareInnerBorderSize) document.styleSheets[0].addRule(rule, `border-width: ${this.squareInnerBorderSize} !important`);
